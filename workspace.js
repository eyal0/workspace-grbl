...
cprequire_test(["inline:com-chilipeppr-workspace-grbl-eyal0"], function(ws) {
...
cpdefine("inline:com-chilipeppr-workspace-grbl-eyal0", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-grbl-eyal0", // Make the id the same as the cpdefine id
